...
export class ArrayPage {
  constructor(page) {
    ...
    this.moduleDescription = page.locator('text=/Arrays are among the oldest/i');
    
    // Topic links
    this.arraysInPythonLink = page.getByRole('link', { name: 'Arrays in Python' });
    this.arraysUsingListLink = page.getByRole('link', { name: 'Arrays Using List' });
    this.basicOperationsLink = page.getByRole('link', { name: 'Basic Operations in Lists' });
    this.applicationsOfArrayLink = page.getByRole('link', { name: 'Applications of Array' });
    ...
    this.maxConsecutiveOnesLink = page.getByRole('link', { name: 'Max Consecutive Ones' });
    this.evenDigitsLink = page.getByRole('link', { name: 'Find Numbers with Even Number of Digits' });
    this.squaresSortedLink = page.getByRole('link', { name: 'Squares of a Sorted Array' });
